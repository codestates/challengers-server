...
const { challenge, like } = require("../models");
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const tagList = await challenge.findAll({
      // //방법1 > unknown table 'like'
      // attributes: [
      //   "challenge.*",
      //   "like.*",
      //   [sequelize.fn("count", "likes.id"), "totalLike"],
      // ],
      // include: [
      //   like,
      ...
      // ],
      // // attributes: [[sequelize.fn("count", sequelize.col("tag_name")), "what"]],
